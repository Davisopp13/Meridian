...
export default function Step3Bookmarklet({ onComplete, onBack }) {
  ...
  const instructions = [
    ...
    'Click it once to launch Meridian, then anytime on a Salesforce case page to log that case',
  ];
